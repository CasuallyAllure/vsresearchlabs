...
// Deno shim for the "Payment received — order processing" notification.
//
// The WHOLE decision body lives in handler.ts (Deno-free, driven directly by
// the vitest suite — tests/unit/sendProcessingNotificationHandler.test.ts).
...
Deno.serve(createProcessingNotificationHandler(
  {
