...
// Deno shim for the "Your order is complete" notification.
//
// The WHOLE decision body lives in handler.ts (Deno-free, driven directly by
// the vitest suite — tests/unit/sendDeliveredNotificationHandler.test.ts).
...
Deno.serve(createDeliveredNotificationHandler(
  {
