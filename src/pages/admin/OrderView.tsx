...
import { catalogPriceCents, effectiveTierPriceCents } from '../../lib/pricing';
...
function StageActions({
  ...
  if (!reached.invoiced) {
    ...
    detail = reached.claimed
      ? `The buyer clicked “I’ve sent payment.” Verify the Zelle deposit landed, then mark received. No stock moves yet.`
      : 'Mark paid once the Zelle deposit lands. No stock moves yet.';
