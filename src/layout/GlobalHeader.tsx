...
export function GlobalHeader({ role = 'guest' }: GlobalHeaderProps) {
  ...
  return (
    <>
      ...
      >
        <div className="relative z-10 h-[74px] px-[var(--space-6)] grid grid-cols-3 items-center">
          ...
          <div className="flex items-center justify-start">
            <button
              ...
              className="p-2 -ml-2 text-ink/70 hover:text-ink transition-colors focus:outline-none focus-visible:ring-1 focus-visible:ring-ink/30"
            >
              <svg
          ...
          <div className="flex items-center justify-center min-w-0">
            <Logo variant="lockup" markSize={60} wordSize={16} />
          </div>
          ...
          <div className="flex items-center justify-end">
            <button
              ...
              className="relative p-2 -mr-2 text-ink/60 hover:text-ink transition-colors focus:outline-none focus-visible:ring-1 focus-visible:ring-ink/30"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="20"
