...
interface MemberAccessGateProps {
  ...
  onGuest: () => void;
  /** 'subtle' = no backdrop scrim blur, a lighter tint, and the canonical
   *  CLEAR glass card (.glass-clear, which self-scopes the dark palette)
   *  instead of the solid card — used when the gate fades in over the
   *  entrance sequence's frozen final frame, which must stay visible behind
   *  and THROUGH it. */
