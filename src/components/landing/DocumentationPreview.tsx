 ...
 *   - Section container is fully flat with `border-b border-white/[0.06]`
    ...
    >
      <div className="mx-auto w-full max-w-[1100px] px-[var(--space-6)] py-[var(--space-16)] sm:py-[var(--space-20)]">
        ...
        <div className="mb-[var(--space-8)] sm:mb-[var(--space-10)]">
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-light text-white tracking-tight leading-[1.1] max-w-[24ch] mb-[var(--space-5)]">
            Batch-tracked
            <br />
            research archive.
          </h2>
          <p className="text-base sm:text-lg text-white/55 leading-relaxed max-w-[58ch]">
