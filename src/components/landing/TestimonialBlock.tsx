 ...
 *   - Hairline grammar matches the rest of Landing: `border-white/[0.06]`.
 *
 * Voice posture:
    ...
    >
      <div className="mx-auto w-full max-w-[1100px] px-[var(--space-6)] py-[var(--space-16)] sm:py-[var(--space-20)]">
        ...
        <div className="mb-[var(--space-10)] sm:mb-[var(--space-12)]">
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-light text-white tracking-tight leading-[1.1] max-w-[22ch]">
            Field references.
          </h2>
        </div>
            ...
            return (
              <li
                ...
                className={[
                  ...
                  !isLast ? 'lg:border-b-0 lg:border-r lg:border-white/[0.06]' : '',
                  isFirst ? 'lg:pl-0' : '',
                  isLast ? 'lg:pr-0' : '',
                ]
                  .filter(Boolean)
              ...
              >
                <figure>
                  ...
                  <blockquote className="text-base sm:text-lg text-white/75 leading-relaxed font-light max-w-[36ch]">
                    “{t.quote}”
                  </blockquote>
                  ...
                  <figcaption className="mt-[var(--space-5)] space-y-[var(--space-1)]">
                    <p className="text-sm text-white/65">— {t.name}</p>
                    <p className="text-[11px] uppercase tracking-[0.2em] text-white/45">
                      {t.role}
                    </p>
                    {t.org && (
                      <p className="text-[11px] text-white/35">{t.org}</p>
                    )}
                  </figcaption>
                </figure>
              </li>
