  ...
  return (
    <span ref={ref} className="relative inline-block align-baseline">
      <button
        ...
        className="cursor-pointer border-b border-dashed border-holo/50 font-medium text-holo transition-colors hover:border-holo focus:outline-none focus-visible:ring-1 focus-visible:ring-holo/40 rounded-[1px]"
      >
        same-day
      </button>
      ...
      {open && (
        <div
          ...
          style={{
            ...
            boxShadow: '0 12px 32px -14px rgba(26,23,20,0.28)',
        ...
        >
          ...
          <p className="mb-2 font-mono text-[8px] uppercase tracking-[0.28em] text-holo">
            Same-Day Delivery Zones
          </p>

          <ul className="mb-2.5 grid grid-cols-2 gap-x-3 gap-y-1">
            {ZONES.map((z) => (
              <li key={z} className="font-mono text-[10px] text-ink/80">
          ...
          <div className="border-t border-holo/20 pt-2">
            <p className="font-mono text-[8.5px] uppercase tracking-[0.2em] text-ink/65">
