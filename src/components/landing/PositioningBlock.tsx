 ...
 *   - Hairline grammar only — `border-b border-ink/[0.06]` to close
  ...
  return (
    ...
    >
      <div className="mx-auto w-full max-w-[1100px] px-[var(--space-6)] py-[var(--space-16)] sm:py-[var(--space-20)]">
        ...
        <h2 className="text-3xl sm:text-4xl lg:text-5xl font-light text-ink tracking-tight leading-[1.1] max-w-[22ch] mb-[var(--space-8)]">
          Inventory-first.
          <br />
          Inquiry-led.
        </h2>
        ...
        <div className="space-y-[var(--space-5)] max-w-[60ch]">
          <p className="text-base sm:text-lg text-ink/65 leading-relaxed">
          ...
          <p className="text-base sm:text-lg text-ink/55 leading-relaxed">
