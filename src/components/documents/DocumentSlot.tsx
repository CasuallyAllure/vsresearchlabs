  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="shrink-0 w-14 aspect-[3/4] overflow-hidden bg-[#050505] border border-white/[0.09]">
        ...
        <div className="flex flex-1 min-w-0 flex-col">
          <div className="flex items-baseline gap-[var(--space-2)] flex-wrap">
            <span
              className="font-mono text-[9px] uppercase tabular-nums tracking-[0.2em] text-white/55"
              style={{
                padding: '1px 5px',
                borderRadius: '2px',
            ...
            <span className="text-[10px] uppercase tracking-[0.2em] text-white/45 truncate">
              {slot.label}
            </span>
          </div>
          <p className="mt-[var(--space-1)] text-[11.5px] text-white/70 truncate">
            {document.productName}
            {document.documentVersion && (
              <span className="ml-2 text-white/35 font-mono">
                {document.documentVersion}
              </span>
            )}
          </p>
          <p className="mt-[var(--space-1)] text-[10px] text-white/40 truncate">
            Issued <DateStamp iso={document.issuedDate} className="text-white/55" />
            {document.issuer && (
              <>
                <span className="mx-1 text-white/20" aria-hidden="true">·</span>
                <span className="text-white/45">{document.issuer}</span>
              </>
            )}
          </p>
        </div>
        ...
        <span
          aria-hidden="true"
          className="shrink-0 text-white/30 transition-colors group-hover:text-gold"
          style={{ fontSize: '14px' }}
        >
          →
        </span>
...
function EmptySlot({ slot }: { slot: SlotDef }) {
  return (
    ...
    >
      ...
      <div className="shrink-0 w-14 aspect-[3/4] flex items-center justify-center bg-[#050505]/40 border border-white/[0.05]">
        <span className="font-mono text-[8px] uppercase tracking-[0.2em] text-white/22">
          {slot.abbreviation}
        </span>
      </div>
      ...
      <div className="flex flex-1 min-w-0 flex-col">
        <div className="flex items-baseline gap-[var(--space-2)] flex-wrap">
          <span
            className="font-mono text-[9px] uppercase tabular-nums tracking-[0.2em] text-white/35"
            style={{
              padding: '1px 5px',
              borderRadius: '2px',
              border: '1px solid rgba(255,255,255,0.07)',
          ...
          <span className="text-[10px] uppercase tracking-[0.2em] text-white/35 truncate">
            {slot.label}
          </span>
        </div>
        <p className="mt-[var(--space-1)] text-[11px] text-white/35">
          Awaiting Upload
        </p>
      </div>
      ...
      <span
        className="shrink-0 font-mono text-[9px] uppercase tracking-[0.2em] text-white/22"
        aria-hidden="true"
      >
        Pending
      </span>
